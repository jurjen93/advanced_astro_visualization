...
class MovieMaker(ImagingLofar):
    ...
    """
    def __init__(self, fits_file: str = None, imsize: float = None, framerate: float = None, process: str = None, fits_download: bool=False):
        """
    ...
    def record(self, audio: bool = False):
        """
